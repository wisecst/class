...
function prev(){if(pin13ResultShown)hidePin13Result();step=Math.max(0,step-1);if(step<2)pin13ResultDone=false;render()}
window.entryLesson={next,prev,getStep:()=>step,max:steps.length,render,isResultOpen:()=>pin13ResultShown,showPin13Result,hidePin13Result};
