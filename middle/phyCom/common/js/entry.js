...
let step=0,pin13ResultShown=false,pin13ResultDone=false,basicResultShown=false,basicResultDone=false,finalResultShown=false,loopRunning=false;
...
function next(){
 ...
 if(step===steps.length&&!finalResultShown){showFinalResult();setLoopRun(true);return;}
 if(step===steps.length&&finalResultShown){hideFinalResult();setLoopRun(false);return;}
