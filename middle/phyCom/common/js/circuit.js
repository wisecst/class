...
function labelPos(w,pts){const name=getWireEnds(w).modulePin.dataset.pin,s=circuitScale();return{x:(pts[0].x+pts[1].x)/2,y:pts[0].y+({IN:-28,VCC:8,GND:32}[name]||0)*s};}
